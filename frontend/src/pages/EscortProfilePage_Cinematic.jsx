                ...
                <div className="space-y-3">
                  ...
                  {profile.phone && (
                    <a
                      ...
                      className="w-full flex items-center justify-center gap-2 py-4 text-base rounded-xl bg-gradient-to-r from-sky-500 to-blue-600 text-white font-semibold hover:brightness-110 transition-all"
                    >
